...
doRecogFeedback = False # was true
...
fastConfig = True #Changed to true
...
if fastConfig: # run fast version to quickly check for errors
    ...
    preListDelay = 50 #150
    preRecallDelay = 60 #120
    jitterBeforeRecall = 600 #20
    recallDuration = 5000 #Make this longer for test space press
